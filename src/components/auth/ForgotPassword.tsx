...
import { TextField, Box, Button, Typography } from "@mui/material";import { FormikProps } from "formik";
import { ForgotPasswordFormik } from "../../pages/auth/ForgotPassPage";
;
const authImage = import.meta.env.VITE_AUTHENTICATION_PAGE_IMAGE;
interface ForgotPasswordProps {
  formik: FormikProps<ForgotPasswordFormik>;
}
